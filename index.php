...
<title>JC MEDICAL STORE</title>
</head>
<body>
	<div id="header" ><img class="i" src="home_page/images/paaru.jpg" >
    <h1 class="head"><br>JC MEDICAL STORE<br></h1><br><h3><marquee>"It is easy to get a thousand prescriptions,but hard to get one single remedy"</h3></marquee>
    <div id="topright" ><h1><a class="foot" href="about/about.html">CONTACT US</a></h1></div>
                        </div>
    ...
    <div class="image-slider">
            ...
            <ul class="rslides" id="slider1">
                <li>
                    <img src="home_page/images/h.jpg" alt="">
                </li>
                <li>
