...
<html>
<head>
<title><?php echo $user;?> -  ADMIN DASHBOARD</title>
...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/admin.png"></a> ADMIN DASHBOARD</h1></div>
<div id="left_column">
<div id="button">
<ul>
 ...
 <!-- Dashboard icons -->
            <div class="grid_7">
                ...
                <a href="admin_pharmacist.php" class="dashboard-module">
                	<img src="images/phar.png"  width="75" height="75" alt="edit" />
                	<span>Pharmacist</span>
                </a>
                
                <a href="admin_manager.php" class="dashboard-module">
                	<img src="images/mana.png"  width="75" height="75" alt="edit" />
                	<span>Manager</span>
                </a>
